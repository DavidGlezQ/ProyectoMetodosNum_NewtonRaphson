...
public class ExampleNewton2Fragment extends Fragment {

    private FragmentExampleNewton2Binding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding = FragmentExampleNewton2Binding.inflate(getLayoutInflater());
        ...
        binding.btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!valorX.isEmpty() && !valorY.isEmpty()){
                    ...
                    res2 = (-2) * Double.parseDouble(valorY);
                    res3 = (-2) * (Double.parseDouble(valorX) -4);
                    res4 = (-2) * (Double.parseDouble(valorY) -4);
                    ...
                    valorSusFun1 = (16 - (Double.parseDouble(valorX) * (Double.parseDouble(valorX)) - Double.parseDouble(valorY) * Double.parseDouble(valorY)));
                    String valorSusFun1String = String.valueOf(valorSusFun1);
                    binding.valorSustFun1.setText(valorSusFun1String);

                    valorSusFun2 = (4 - ((Double.parseDouble(valorX) - 4)) - (Double.parseDouble(valorX) - 4)) - (4 - ((Double.parseDouble(valorX) - 4)) - (Double.parseDouble(valorX) - 4));
